...
$.fn.initTabs = function(mobilegrid) {
  ...
  // ✅ Preload all other tabs in background
  _.find('.nav-link').each(function() {
    var href = $(this).attr('href');
    var panel = $(href).find('.ajaxcontent');

    if (panel.length && !panel.data('loaded') && panel.hasClass('startajax')) {
  ...
  // Bind tab clicks (just show content, no more AJAX delay)
  _.find('.nav-link').on('click', function(e) {
    e.preventDefault();
    var $this = $(this);
    var panel = $($this.attr('href')).find('.ajaxcontent');

    // Content is already preloaded → just resize again
    resizeTabImages(panel);
    alignmentArrowValue();
  });
};
